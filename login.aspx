    ...
    <body style="background-image: url(Src/VideoWall.jpg);">
        ...
        <div class="container bg-white " id="login">
            <form>
                ...
                <p class="text-dark" style="font-size:50%;">توجه: برای استفاده بهتر پیشنهاد می شود از مرورگر Firefox-esr و نیز vlc-2.2.6 استفاده کنید. این ابزارها را می توانید از <a href="./Src/Softwares.zip">اینجا </a>دریافت کنید</p>
            </form>
